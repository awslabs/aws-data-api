...
class Neptune:
    ...
    def _remoteConnection(self, neptune_endpoint=None, neptune_port=None, show_endpoint=False,
    ...
    def graphTraversal(self, neptune_endpoint=None, neptune_port=None, show_endpoint=True, connection=None,
        ...
        if connection is None:
            connection = self._remoteConnection(neptune_endpoint, neptune_port, show_endpoint, retry_limit=retry_limit)
        graph = Graph()
        return graph.traversal().withRemote(connection)

    def clear(self, neptune_endpoint=None, neptune_port=None, batch_size=200, edge_batch_size=None,
    ...
    def clearGremlin(self, neptune_endpoint=None, neptune_port=None, batch_size=200, edge_batch_size=None,
                     vertex_batch_size=None):
        ...
        while has_edges:
            if edge_count is None:
                print(
                    'clearing property graph data [edge_batch_size={}, edge_count=Unknown]...'.format(edge_batch_size))
            else:
                print('clearing property graph data [edge_batch_size={}, edge_count={}]...'.format(edge_batch_size,
                                                                                                   edge_count))
        ...
        while has_vertices:
            if vertex_count is None:
                print('clearing property graph data [vertex_batch_size={}, vertex_count=Unknown]...'.format(
                    vertex_batch_size))
            else:
                print(
                    'clearing property graph data [vertex_batch_size={}, vertex_count={}]...'.format(vertex_batch_size,
                                                                                                     vertex_count))
    ...
    def bulkLoad(self, source, format='csv', role=None, region=None, neptune_endpoint=None, neptune_port=None,
                 interval=2):
    ...
    def gremlin_endpoint(self, neptune_endpoint=None, neptune_port=None):
        return self.__endpoint('ws', self.__neptune_endpoint(neptune_endpoint), self.__neptune_port(neptune_port),
                               'gremlin')

    def sparql_endpoint(self, neptune_endpoint=None, neptune_port=None):
        return self.__endpoint('http', self.__neptune_endpoint(neptune_endpoint), self.__neptune_port(neptune_port),
                               'sparql')
